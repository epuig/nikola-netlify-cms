...
BLOG_AUTHOR = "Enrique Puig"  # (translatable)
BLOG_TITLE = "Probando Nikola Site"  # (translatable)
...
BLOG_DESCRIPTION = "ºEsto es una sitio construido con Nikola por Enrique."  # (translatable)
